...
struct parser_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("ignore_user_patterns", CPK_BOOL, "ignore patterns provided by the user", "false");
    d.insert("ignore_bad_patterns", CPK_BOOL, "ignore malformed patterns", "true");
    d.insert("error_for_visual_studio", CPK_BOOL, "display error messages in Visual Studio format", "false");
  }
  /*
