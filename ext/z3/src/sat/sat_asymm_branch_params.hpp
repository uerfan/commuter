...
struct sat_asymm_branch_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("asymm_branch", CPK_BOOL, "asymmetric branching", "true");
    d.insert("asymm_branch.rounds", CPK_UINT, "maximum number of rounds of asymmetric branching", "32");
    d.insert("asymm_branch.limit", CPK_UINT, "approx. maximum number of literals visited during asymmetric branching", "100000000");
  }
  /*
