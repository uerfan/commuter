...
struct poly_rewriter_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("som", CPK_BOOL, "put polynomials in som-of-monomials form", "false");
    d.insert("som_blowup", CPK_UINT, "maximum number of monomials generated when putting a polynomial in sum-of-monomials normal form", "4294967295");
    d.insert("hoist_mul", CPK_BOOL, "hoist multiplication over summation to minimize number of multiplications", "false");
    d.insert("hoist_cmul", CPK_BOOL, "hoist constant multiplication over summation to minimize number of multiplications", "false");
