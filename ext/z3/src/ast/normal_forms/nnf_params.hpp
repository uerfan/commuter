...
struct nnf_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("sk_hack", CPK_BOOL, "hack for VCC", "false");
    d.insert("mode", CPK_SYMBOL, "NNF translation mode: skolem (skolem normal form), quantifiers (skolem normal form + quantifiers in NNF), full", "skolem");
    d.insert("ignore_labels", CPK_BOOL, "remove/ignore labels in the input formula, this option is ignored if proofs are enabled", "false");
    d.insert("skolemize", CPK_BOOL, "skolemize (existential force) quantifiers", "true");
  }
  /*
