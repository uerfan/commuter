...
struct array_simplifier_params_helper {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("array.canonize", CPK_BOOL, "normalize array terms into normal form during simplification", "false");
    d.insert("array.simplify", CPK_BOOL, "enable/disable array simplifications", "true");
  }
  /*
