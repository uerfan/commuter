...
struct arith_simplifier_params_helper {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("arith.expand_eqs", CPK_BOOL, "expand equalities into two inequalities", "false");
    d.insert("arith.process_all_eqs", CPK_BOOL, "put all equations in the form (= t c), where c is a numeral", "false");
  }
  /*
