...
struct model_evaluator_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("completion", CPK_BOOL, "assigns an interptetation to symbols that do not have one in the current model, when evaluating expressions in the current model", "false");
    d.insert("cache", CPK_BOOL, "cache intermediate results in the model evaluator", "true");
  }
  /*
