...
struct model_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("partial", CPK_BOOL, "enable/disable partial function interpretations", "false");
    d.insert("v1", CPK_BOOL, "use Z3 version 1.x pretty printer", "false");
    d.insert("v2", CPK_BOOL, "use Z3 version 2.x (x <= 16) pretty printer", "false");
    d.insert("compact", CPK_BOOL, "try to compact function graph (i.e., function interpretations that are lookup tables)", "false");
  }
  /*
