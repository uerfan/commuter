...
struct algebraic_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("factor", CPK_BOOL, "use polynomial factorization to simplify polynomials representing algebraic numbers", "true");
    d.insert("factor_max_prime", CPK_UINT, "parameter for the polynomial factorization procedure in the algebraic number module. Z3 polynomial factorization is composed of three steps: factorization in GF(p), lifting and search. This parameter limits the maximum prime number p to be used in the first step", "31");
    ...
    d.insert("factor_search_size", CPK_UINT, "parameter for the polynomial factorization procedure in the algebraic number module. Z3 polynomial factorization is composed of three steps: factorization in GF(p), lifting and search. This parameter can be used to limit the search space", "5000");
  }
  /*
