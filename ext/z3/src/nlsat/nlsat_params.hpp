...
struct nlsat_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("lazy", CPK_UINT, "how lazy the solver is.", "0");
    d.insert("reorder", CPK_BOOL, "reorder variables.", "true");
    d.insert("simplify_conflicts", CPK_BOOL, "simplify conflicts using equalities before resolving them in nlsat solver.", "true");
    d.insert("minimize_conflicts", CPK_BOOL, "minimize conflicts", "false");
    d.insert("randomize", CPK_BOOL, "randomize selection of a witness in nlsat.", "true");
    d.insert("max_conflicts", CPK_UINT, "maximum number of conflicts.", "4294967295");
    d.insert("shuffle_vars", CPK_BOOL, "use a random variable order.", "false");
    d.insert("seed", CPK_UINT, "random seed.", "0");
    d.insert("factor", CPK_BOOL, "factor polynomials produced during conflict resolution.", "true");
  }
  /*
